...
def string_input(data_str):
    ...
    X_test = df[['count.', 'count-www', 'count@',
        'count_dir', 'count_embed_domian', 'short_url', 'count%', 'count?', 'count-', 'count=', 'url_length',
          'count-digits']]
    import pickle
    with open("C:/Users/fa19-bcs-040.cuiwah/Desktop/biggerLinks/xgboost_model.pkl", "rb") as f:
        xgb_model = pickle.load(f)
    # y_pred1 = model.predict(X)
    with open("C:/Users/fa19-bcs-040.cuiwah/Desktop/biggerLinks/gbdt_model.pkl", "rb") as f:
        gbdt_model = pickle.load(f)
    # y_pred2 = model.predict(X)
    with open("C:/Users/fa19-bcs-040.cuiwah/Desktop/biggerLinks/lgb_model.pkl", "rb") as f:
        lgb_model = pickle.load(f)
    # y_pred3 = model.predict(X)
    with open('C:/Users/fa19-bcs-040.cuiwah/Desktop/biggerLinks/random_forest_model.pkl', 'rb') as f:
...
print(string_input("https://www.facebook.com/"))